...
class AttestationCess(models.Model):
    _name = 'softy.attestations'
    _description = 'Attestation de Cessation'
    _rec_name = 'ref'
    ...
    date_cess = fields.Date(
        string='Date de Cessation',
        required=True
    )
    ...
    def action_print_attestation_cess(self):
        """Print the cessation attestation"""
        return self.env.ref('softy_hr.report_attestation_cess_document').report_action(self)