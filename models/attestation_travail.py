...
class AttestationTravail(models.Model):
    _name = 'softy.attestationt'
    _description = 'Attestation Travail'
    _rec_name = 'ref'
    ...
    def action_print_attestation(self):
        """Print the work attestation"""
        return self.env.ref('softy_hr.report_attestation_document').report_action(self)